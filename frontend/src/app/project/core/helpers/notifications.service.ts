...
export class NotificationsService {
  ...
  public toastMessage(message: string, type:string = "info", duration:number = 3000)
    ...
    public swalPrompt(title:any, confirmText = "Tamam", cancelText = "İptal", inputType = "text")
    {
    ...
    public swalComboBox(title:any, inputOptions:any, confirmText = "Tamam", cancelText = "İptal")
    {
        return Swal.fire(
        {
            title: title,
    ...
    public swalConfirm(title:any, text:any, icon:any, confirmButtonText = 'Evet', cancelButtonText = 'Hayır', showCancelButton = true)
    {
        return Swal.fire(
        {
            title: title,
